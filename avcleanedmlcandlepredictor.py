...
def train_and_predict_for_pair(pair):
    ...
    # If there's no 'Volume' column, create one (fix to avoid KeyError)
    ...
    # The rest of your code is EXACTLY the same as before:
    ...
    Y = df[['LogTomorrow_High','LogTomorrow_Low']].values
    ...
    # Print tail(5) to debug last rows
    print(df.tail(5))
